    ...
    <section id="about">
      <div className="reveal">
        ...
        <div className="a-stats">
          <div><p className="a-sn">5+</p><p className="a-sl">Years<br />Experience</p></div>
          <div><p className="a-sn">60+</p><p className="a-sl">Projects<br />Delivered</p></div>
          <div><p className="a-sn">30+</p><p className="a-sl">Happy<br />Clients</p></div>
        </div>
      </div>
